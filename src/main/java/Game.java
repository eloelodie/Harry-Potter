...
public class Game {
    ...
    Boss Voldemort = new Boss("Voldemort", 500, 30, new ArrayList<>(Arrays.asList(avadaKedavra, crucio)), 50);
    Boss PeterPettigrew = new Boss("Peter Pettigrew", 250, 20, new ArrayList<>(Arrays.asList(imperio, crucio)), 30);
    Boss DoloresUmbridge = new Boss("Dolores Umbridge", 260, 25, new ArrayList<>(Arrays.asList(imperio, crucio)), 30);
    Boss BellatrixLestrange = new Boss("Bellatrix Lestrange", 260, 25, new ArrayList<>(Arrays.asList(avadaKedavra, imperio)), 30);
    ...
    Level[] levels = new Level[]{
            ...
            new Level(new Hogwarts(), "Hogwarts", null, new ArrayList<>(Arrays.asList(Voldemort, BellatrixLestrange)))
    };
    ...
    public void initialisation() {
        ...
        wizard = new Wizard(name, wand, 500, 30);
